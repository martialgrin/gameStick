...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    key: "initListeners",
    value: function initListeners() {// this.mouseDownHandler = this.onMouseDown.bind(this);
    ...
    value: function setup() {
      this.initListeners(); // this.draw();
    }
  }, {
    key: "draw",
    value: function draw() {// this.ctx.clearRect(0, 0, this.w, this.h);
      // console.log("draw");
